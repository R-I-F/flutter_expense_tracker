    ...
    return Expanded(
      child: ListView.builder(
          ...
          itemBuilder: (ctx, index) {
            ...
            return Dismissible(
                key: ValueKey(expenseData[index].id),
                background: Container(color: Theme.of(context).colorScheme.error,),
                onDismissed: (DismissDirection? direction)=>ref.read(expenseProvider.notifier).deleteExpense(expenseData[index].id, ctx),
                child: Card(
                      ...
                      children: [
                        Column(
                            ...
                            children: [
                              ...
                              Text(
                                  '\$${expenseData[index].cost.toStringAsFixed(2)}',
